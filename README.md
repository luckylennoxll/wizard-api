...
<a href="https://pkg.go.dev/github.com/luckylennoxll/wizard-api"><img src="https://pkg.go.dev/badge/github.com/luckylennoxll/wizard-api.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/luckylennoxll/wizard-api" // imported as audioreworkvisions
)
```
...
```sh
go get -u 'github.com/luckylennoxll/wizard-api@v0.0.1-alpha.0'
```
...
The full list of request options is [here](https://pkg.go.dev/github.com/luckylennoxll/wizard-api/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/luckylennoxll/wizard-api/issues) with questions, bugs, or suggestions.
