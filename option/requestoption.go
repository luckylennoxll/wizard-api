...
import (
	...
	"github.com/luckylennoxll/wizard-api/internal/requestconfig"
	"github.com/tidwall/sjson"
)

// RequestOption is an option for the requests made by the audioreworkvisions API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/luckylennoxll/wizard-api#readme-requestoptions
